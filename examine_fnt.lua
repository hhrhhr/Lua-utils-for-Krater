...
-- generate glyph list: 32-126,160-255,1025,1040-1103,1105...
local str = ""
local old = -1
local new = -1
local p = 0
...
print(string.format("size=%d, height=%d, base=%d, width=%d, height=%d",
        fnt.size, fnt.height, fnt.base, fnt.tex_width, fnt.tex_heigth))
print(str)
